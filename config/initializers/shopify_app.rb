ShopifyApp.configure do |config|
  ...
  config.old_secret = ""
  config.scope = "read_products, write_products, read_customers, write_customers, read_orders, write_orders, read_product_listings" # Consult this page for more scope options:
